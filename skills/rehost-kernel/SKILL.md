---
name: rehost-kernel
description: (폐기됨 · v0.19.0) 트랙 2 (커널+스토리지) 실행 명령이었다. 트랙 2종이 통합 체인 하나로 대체되어 이 명령은 더 이상 파이프라인을 호출하지 않는다. /sboot-rehost:rehost-full 로 안내하고 종료한다.
...
> `/sboot-rehost:rehost-kernel` 은 **`/sboot-rehost:rehost-full`** 로 대체됐습니다.
>
...
> | 예전 | 지금 |
> |---|---|
> | 트랙 2 (커널+스토리지) | `/sboot-rehost:rehost-full --target F3` |
>
