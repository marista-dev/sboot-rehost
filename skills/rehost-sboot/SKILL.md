...
- reality-verifier → VERIFICATION.md. 5/5 = REAL → Phase 5. 4/5 이하 = FORCED → 사용자 확인.
...
## Step 5 — JOURNAL 세션 종료 (필수)

파이프라인이 끝나면 (5/5 REAL / FORCED / 에러 / 셸 미도달 무관):
```
